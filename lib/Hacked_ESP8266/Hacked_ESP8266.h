...
#ifndef _HACKED_ESP8266_H_
#define _HACKED_ESP8266_H_
...
class Hacked_ESP8266 : public Print {
 public:
  Hacked_ESP8266(Stream *s = &Serial, Stream *d = NULL, int8_t r = -1);
  boolean   hardReset(void),
            ...
            requestURL(Fstr *url),
            requestURL(char* url),
            postRequest(Fstr *url, char* json);
            // postRequest(Fstr *url, char* json);
